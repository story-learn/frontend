...
const SuccessIcon: FC = () => {
    return (
        ...
        >
            <path
                opacity="0.4"
                d="M16.3402 1.99982H7.67024C4.28024 1.99982 2.00024 4.37982 2.00024 7.91982V16.0898C2.00024 19.6198 4.28024 21.9998 7.67024 21.9998H16.3402C19.7302 21.9998 22.0002 19.6198 22.0002 16.0898V7.91982C22.0002 4.37982 19.7302 1.99982 16.3402 1.99982Z"
                fill="#27AE60"
            />
            <path
